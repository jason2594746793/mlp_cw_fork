...
However, the validation error (red) decreases initially but starts to increase after around epoch 15-20.
This divergence between training and validation performance is the hallmark of overfitting: the model is memorizing the training set (high capacity) but failing to generalize to unseen data.}
}
...
\youranswer{Question Table 4 - Results for Combined L1 and L2 Regularization.
\begin{table}[h]
    \centering
