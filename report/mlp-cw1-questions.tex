...
\youranswer{Question 1 - Figure \ref{fig:example_acccurves} shows the training and validation accuracy, while Figure \ref{fig:example_errorcurves} shows the cross-entropy error.
The training accuracy (blue) rapidly increases to near 100\% and the training error (blue) decreases to near 0, indicating the model learns the training data perfectly.
However, the validation error (red) decreases initially but starts to increase after around epoch 15-20, while validation accuracy plateaus and even slightly decreases.
This divergence between training and validation performance is the hallmark of overfitting: the model is memorizing the training set (high capacity) but failing to generalize to unseen data (increasing validation error).}
}
...
\youranswer{Question Figure 5 - Validation Accuracy and Generalisation Gap for Combined L1/L2 Experiments.
   \begin{figure}[h]
       \centering
       \includegraphics[width=0.8\linewidth]{figures/empty_combined_reg_plot.png}
...
\youranswer{Question Figure 6 - Training Accuracy, Error, and Gradient Flow for Custom Activation Function.
   \begin{figure}[h]
       ...
       \begin{subfigure}{0.32\linewidth}
           \includegraphics[width=\linewidth]{figures/empty_custom_act_acc.png}
           \caption{Accuracy}
       \end{subfigure}
       \begin{subfigure}{0.32\linewidth}
           \includegraphics[width=\linewidth]{figures/empty_custom_act_error.png}
           \caption{Error}
       \end{subfigure}
       \begin{subfigure}{0.32\linewidth}
           \includegraphics[width=\linewidth]{figures/empty_custom_act_grad_flow.png}
